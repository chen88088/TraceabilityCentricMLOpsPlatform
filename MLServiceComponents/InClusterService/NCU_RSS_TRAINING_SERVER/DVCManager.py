...
class DVCManager:
    ...
    def init_worker(self, dag_id: str, execution_id: str , git_repo_path: str, dataset_title: str = None):
        worker_key = f"{dag_id}_{execution_id}"
        dataset_bucket = dataset_title if dataset_title else config.DATASET_STORAGE_MINIO_BUCKET
        if worker_key not in self.workers:
            ...
            worker = DVCWorker(
                ...
                dataset_storage_minio_bucket= dataset_bucket,
