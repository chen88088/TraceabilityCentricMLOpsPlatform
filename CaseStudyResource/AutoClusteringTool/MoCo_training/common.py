...
def get_arguments():
    ...
    parser.add_argument("--epochs",         type=int,       default=300) #3000
    ...
    parser.add_argument("--tb_interval",    type=int,       default=5)
    parser.add_argument("--tb_histogram",   type=int,       default=5)
