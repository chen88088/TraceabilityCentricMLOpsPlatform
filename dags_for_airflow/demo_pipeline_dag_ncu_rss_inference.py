...
# 全局配置parameter
API_GLOBAL_CONFIG = {
    "DAG_NAME": "yyyytestpipelinencurssinference",
    ...
    "CODE_REPO_URL": {
        ...
        "Inference": "https://github.com/chen88088/NCU-RSS-1.5.git",
        "Postprocessing": "https://github.com/chen88088/NCU-RSS-Predict-Postprocessing.git"
    },

    "IMAGE_NAME":{
        "Preprocessing": "",
        "Inference": "moa_ncu/ncu-rss-inference",
        "Postprocessing": ""
    },

    "MODEL_NAME": "ncu_rss_1.5",
    "MODEL_VERSION": "2",

    # deployer info
    "DEPLOYER_NAME": "Jenny",
    "DEPLOYER_EMAIL": "jenny@mlops.com",
    ...
    "PIPELINE_STAGE_SERVICE_IMAGE_CONFIG" :
    {
        "INFERENCE" : 
        {
            "SERVICE_NAME": "NCU_RSS_Inference_Service",
            "SERVICE_IMAGE_NAME":"moa_ncu/ncu-rss-inference-server",
...
# Kafka 配置
kafka_conf = {
    'bootstrap.servers': KAFKA_SERVICE_CONFIG["KAFKA_BROKER_URL"]  # 替换为你的 Kafka broker 地址
}
...
# 取出 config 中的設定
stage_service_config = API_GLOBAL_CONFIG["PIPELINE_STAGE_SERVICE_IMAGE_CONFIG"]["INFERENCE"]

# function of get service info
Get_NCU_RSS_Inference_Service_Information = PythonOperator(
    task_id='Get_NCU_RSS_Inference_Service_Information',
...
Inference_RegisterDag= PythonOperator(
    task_id='Inference_RegisterDag',
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'Get_NCU_RSS_Inference_Service_Information',
        'task_stage_type': 'Inference',
        'route': 'Inference/RegisterDag'
    },
    dag=dag,
)

# [Inference/SetupFolder]
Inference_SetupFolder= PythonOperator(
    task_id='Inference_SetupFolder',
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'Get_NCU_RSS_Inference_Service_Information',
        'task_stage_type': 'Inference',
        'route': 'Inference/SetupFolder'
    },
    dag=dag,
)

# [Inference/DownloadPreprocessingResult]
Inference_DownloadPreprocessingResult= PythonOperator(
    task_id='Inference_DownloadPreprocessingResult',
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'Get_NCU_RSS_Inference_Service_Information',
        'task_stage_type': 'Inference',
        'route': 'Inference/DownloadPreprocessingResult'
    },
    dag=dag,
)

# [Inference/FetchModel]
Inference_FetchModel= PythonOperator(
    task_id='Inference_FetchModel',
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'Get_NCU_RSS_Inference_Service_Information',
        'task_stage_type': 'Inference',
        'route': 'Inference/FetchModel'
    },
    dag=dag,
)

# [Inference/ExecuteInferenceScripts]
Inference_ExecuteInferenceScripts= PythonOperator(
    task_id='Inference_ExecuteTrainingScripts',
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'Get_NCU_RSS_Inference_Service_Information',
        'task_stage_type': 'Inference',
        'route': 'Inference/ExecuteInferenceScripts'
...
Inference_UploadInferenceOutputFiles= PythonOperator(
    task_id='Inference_UploadInferenceOutputFiles',
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'Get_NCU_RSS_Inference_Service_Information',
        'task_stage_type': 'Inference',
        'route': 'Inference/UploadInferenceOutputFiles'

    },
    dag=dag,
)

# [Inference/UploadLogToS3]
Inference_UploadLogToS3= PythonOperator(
    task_id='Inference_UploadLogToS3',
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'Get_NCU_RSS_Inference_Service_Information',
        'task_stage_type': 'Inference',
        'route': 'Inference/UploadLogToS3'
    },
    dag=dag,
)

Delete_NCU_RSS_Inference_Service_ML_Serving_Pod = PythonOperator(
    task_id='Delete_NCU_RSS_Inference_Service_ML_Serving_Pod',
...
# [GetPostprocessingServiceInfomation]
Get_Postprocessing_Service_Information = PythonOperator(
    task_id='Get_Postprocessing_Service_Information',
    python_callable=get_external_service_info,
    op_kwargs={
...
Postprocessing_RegisterDag= PythonOperator(
    task_id='Postprocessing_RegisterDag',
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'Get_Postprocessing_Service_Information',
        'task_stage_type': 'Postprocessing',
        'route': 'Postprocessing/RegisterDag'
    },
    dag=dag,
)

# [Postprocessing/SetupFolder]
Postprocessing_SetupFolder= PythonOperator(
    task_id='Postprocessing_SetupFolder',
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'Get_Postprocessing_Service_Information',
        'task_stage_type': 'Postprocessing',
        'route': 'Postprocessing/SetupFolder'
    },
    dag=dag,
)

# [Postprocessing/DownloadInferenceOutputFiles]
Postprocessing_DownloadInferenceOutputFiles= PythonOperator(
    task_id='Postprocessing_DownloadInferenceOutputFiles',
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'Get_Postprocessing_Service_Information',
        'task_stage_type': 'Postprocessing',
        'route': 'Postprocessing/DownloadInferenceOutputFiles'
    },
    dag=dag,
)

# [Postprocessing/ModifyPostprocessingConfig]
Postprocessing_ModifyPostprocessingConfig= PythonOperator(
    task_id='Postprocessing_ModifyPostprocessingConfig',
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'Get_Postprocessing_Service_Information',
        'task_stage_type': 'Postprocessing',
        'route': 'Postprocessing/ModifyPostprocessingConfig'
    },
    dag=dag,
)

# [Postprocessing/ExecutePostprocessing]
Postprocessing_ExecutePostprocessing= PythonOperator(
    task_id='Postprocessing_ExecutePostprocessing',
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'Get_Postprocessing_Service_Information',
        'task_stage_type': 'Postprocessing',
        'route': 'Postprocessing/ExecutePostprocessing'
    },
    dag=dag,
)

# [Postprocessing/UploadLogToS3]
Postprocessing_UploadLogToS3= PythonOperator(
    task_id='Postprocessing_UploadLogToS3',
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'Get_Postprocessing_Service_Information',
        'task_stage_type': 'Postprocessing',
        'route': 'Postprocessing/UploadLogToS3'
    },
    dag=dag,
)

# function to release service 
Release_Postprocessing_Service = PythonOperator(
    task_id='Release_Postprocessing_Service',
    python_callable=release_external_service,
    op_kwargs={
        'info_source_task_ids': 'Get_Postprocessing_Service_Information'
    },
...
(
    ...
    >> Get_NCU_RSS_Inference_Service_Information
    >> Inference_RegisterDag
    >> Inference_SetupFolder
    >> Inference_DownloadPreprocessingResult
    >> Inference_FetchModel
    >> Inference_ExecuteInferenceScripts
    >> Inference_UploadInferenceOutputFiles
    >> Inference_UploadLogToS3
    >> Delete_NCU_RSS_Inference_Service_ML_Serving_Pod
    >> Get_Postprocessing_Service_Information
    >> Postprocessing_RegisterDag
    >> Postprocessing_SetupFolder
    >> Postprocessing_DownloadInferenceOutputFiles
    >> Postprocessing_ModifyPostprocessingConfig
    >> Postprocessing_ExecutePostprocessing
    >> Postprocessing_UploadLogToS3
    >> Release_Postprocessing_Service
)
