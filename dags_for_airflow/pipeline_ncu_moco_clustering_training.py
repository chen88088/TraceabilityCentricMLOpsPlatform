...
# 全局配置parameter
API_GLOBAL_CONFIG = {
    "DAG_NAME": "xxxtestdagclusteringtraining",
...
GetClusteringTrainingServiceInformation = PythonOperator(
    task_id='GetClusteringTrainingServiceInformation',
    python_callable=get_ml_serving_pod_info,
    op_kwargs={
        'ml_serving_pod_image_name': 'ncu-moco-clustering-training-server',
        'image_tag': 'latest',
        'export_port': 8009
    },
    dag=dag,
...
Clustering_RegisterDag= PythonOperator(
    ...
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'GetClusteringTrainingServiceInformation',
...
(
    ...
    >> GetClusteringTrainingServiceInformation 
