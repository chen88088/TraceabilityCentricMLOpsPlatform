...
# Kafka 配置
kafka_conf = {
    'bootstrap.servers': SERVICE_CONFIG["KAFKA_BROKER_URL"]  # 替换为你的 Kafka broker 地址
}
...
GetPreprocessingServiceInfomation = PythonOperator(
    task_id='GetPreprocessingServiceInfomation',
...
Preprocessing_RegisterDag= PythonOperator(
    ...
    op_kwargs={
        'info_source_task_ids': 'GetPreprocessingServiceInfomation',
...
GetInferenceServiceInfomation = PythonOperator(
    task_id='GetInferenceServiceInfomation',
    python_callable=get_ml_serving_pod_info,
    op_kwargs={
        'ml_serving_pod_image_name': 'ncu-rss-inference-server',
        'image_tag': 'latest',
        'export_port': 8007
    },
    dag=dag,
...
Inference_RegisterDag= PythonOperator(
    ...
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'GetInferenceServiceInfomation',
...
Release_Inference_Service = PythonOperator(
    task_id='Delete_ML_Serving_Pod',
...
GetPostprocessingServiceInfomation = PythonOperator(
    task_id='GetPostprocessingServiceInfomation',
    python_callable=get_external_service_info,
    op_kwargs={
...
Postprocessing_RegisterDag= PythonOperator(
    ...
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'GetPostprocessingServiceInfomation',
...
(
    GenerateExecutionID
    >> GetPreprocessingServiceInfomation 
