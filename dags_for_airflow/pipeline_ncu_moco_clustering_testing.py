...
# 全局配置parameter
API_GLOBAL_CONFIG = {
    "DAG_NAME": "xxxtestdagclusteringtesting",
...
GetClusteringTestingServiceInformation = PythonOperator(
    task_id='GetClusteringTestingServiceInformation',
    python_callable=get_ml_serving_pod_info,
    op_kwargs={
        'ml_serving_pod_image_name': 'ncu-moco-clustering-testing-server',
        'image_tag': 'latest',
        'export_port': 8011
    },
    dag=dag,
...
Clustering_RegisterDag= PythonOperator(
    ...
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'GetClusteringTestingServiceInformation',
...
(
    ...
    >> GetClusteringTestingServiceInformation 
