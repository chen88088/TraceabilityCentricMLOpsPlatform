...
# 全局配置parameter
API_GLOBAL_CONFIG = {
    "DAG_NAME": "testcompletegeneraltrainingworkflow",
    ...
    "CODE_REPO_URL": 
    {
        "Training": "https://github.com/chen88088/Prediction-of-Car-Insurance-Claim.git"
    },

    "IMAGE_NAME":
    {
        "Training": "moa_ncu/car-insurance-lightgbm-training"
    },
    "EXECUTION_SCRIPTS":
    {
        "Training": [
            "lightgbmoptimization.py"
        ]
    },
    "UPLOAD_MLFLOW_SCRIPT": {
        "Training": "lightgbmoptimization_result_to_mlflow.py"
    },
    ...
    "PIPELINE_STAGE_SERVICE_IMAGE_CONFIG":
    {
        "Training" : 
        {
            "SERVICE_NAME": "General-Model-Training-Service",
            "SERVICE_IMAGE_NAME":"moa_ncu/general-model-training-server",
...
class ApiCaller:
    ...
    def create_request_body(self, task_stage_type: str):
        ...
        return {
            ...
            "DATASET_DVCFILE_REPO": API_GLOBAL_CONFIG["DATASET_DVCFILE_REPO"],
            
            "CODE_REPO_URL": API_GLOBAL_CONFIG["CODE_REPO_URL"],
            
            "IMAGE_NAME": API_GLOBAL_CONFIG["IMAGE_NAME"],
            "EXECUTION_SCRIPTS": API_GLOBAL_CONFIG["EXECUTION_SCRIPTS"],

            "UPLOAD_MLFLOW_SCRIPT": API_GLOBAL_CONFIG["UPLOAD_MLFLOW_SCRIPT"],
...
#################################
# 取出 config 中的設定
stage_service_config = API_GLOBAL_CONFIG["PIPELINE_STAGE_SERVICE_IMAGE_CONFIG"]["Training"]

# function of get service info
Get_General_Model_Training_Service_Information = PythonOperator(
    task_id='Get_General_Model_Training_Service_Information',
...
Training_Register_Dag= PythonOperator(
    task_id='Training_Register_Dag',
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'Get_General_Model_Training_Service_Information',
...
Training_Download_Dataset= PythonOperator(
    task_id='Training_Download_Dataset',
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'Get_General_Model_Training_Service_Information',
        'task_stage_type': 'Training',
...
Training_Download_CodeRepo= PythonOperator(
    task_id='Training_Download_CodeRepo',
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'Get_General_Model_Training_Service_Information',
        'task_stage_type': 'Training',
...
# [Training/Add_Config]
Training_Add_Config= PythonOperator(
    task_id='Training_Add_Config',
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'Get_General_Model_Training_Service_Information',
        'task_stage_type': 'Training',
...
Training_Execute_TrainingScripts= PythonOperator(
    task_id='Training_Execute_TrainingScripts',
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'Get_General_Model_Training_Service_Information',
        'task_stage_type': 'Training',
...
Training_Upload_ExperimentResult= PythonOperator(
    task_id='Training_Upload_ExperimentResult',
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'Get_General_Model_Training_Service_Information',
        'task_stage_type': 'Training',
...
# [Training/Upload_Log]
Training_Upload_Log= PythonOperator(
    task_id='Training_Upload_Log',
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'Get_General_Model_Training_Service_Information',
        'task_stage_type': 'Training',
...
Delete_General_Model_Training_ML_Serving_Pod = PythonOperator(
    task_id='Delete_General_Model_Training_ML_Serving_Pod',
...
(
    ...
    >> Get_General_Model_Training_Service_Information
    >> Training_Register_Dag
    >> Training_Download_Dataset
    >> Training_Download_CodeRepo
    >> Training_Add_Config
    >> Training_Execute_TrainingScripts
    >> Training_Upload_ExperimentResult
    >> Training_Upload_Log
    >> Delete_General_Model_Training_ML_Serving_Pod
)
