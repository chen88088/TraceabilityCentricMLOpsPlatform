...
##testclusteringtrainingtemplate
##########################################
# 全局配置parameter
API_GLOBAL_CONFIG = {
    "DAG_NAME": "casestudy2pipelinencumococlusteringtraining",
    ...
    "IMAGE_NAME":{
        "Preprocessing": "",
        "Clustering": "moa_ncu/ncu-moco-clustering-training"
    },
    ...
    "PIPELINE_STAGE_SERVICE_IMAGE_CONFIG" :
    {
        "CLUSTERING" : 
        {
            "SERVICE_NAME": "NCU_MoCo_Clustering_Training_Service",
            "SERVICE_IMAGE_NAME":"moa_ncu/ncu-moco-clustering-training-server",
...
class ApiCaller:
    ...
    def call_api(self, route):
        ...
        try:
            response = requests.post(target_api_url, json=self.body,  timeout=108000)
...
Get_Clustering_Training_Service_Information = PythonOperator(
    task_id='Get_Clustering_Training_Service_Information',
...
Clustering_RegisterDag= PythonOperator(
    ...
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'Get_Clustering_Training_Service_Information',
...
Clustering_ExecuteClusteringTrainingScripts= PythonOperator(
    task_id='Clustering_ExecuteClusteringTrainingScripts',
    python_callable=call_api_task,
    op_kwargs={
        'info_source_task_ids': 'Get_Clustering_Training_Service_Information',
        'task_stage_type': 'Clustering',
        'route': 'Clustering/ExecuteClusteringTrainingScripts'
...
Delete_Clustering_Training_ML_Serving_Pod = PythonOperator(
    task_id='Delete_Clustering_Training_ML_Serving_Pod',
...
(
    ...
    >> Get_Clustering_Training_Service_Information 
    >> Clustering_RegisterDag
    >> Clustering_SetupFolder
    >> Clustering_DownloadPreprocessingResult
    >> Clustering_ExecuteClusteringTrainingScripts
    >> Clustering_UploadLogToS3
    >> Delete_Clustering_Training_ML_Serving_Pod
)
